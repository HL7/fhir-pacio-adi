Profile: ADIPersonAuthoredPreferenceCarePlan
Parent: $USCoreCarePlan
Id: ADI-PersonAuthoredPreferenceCarePlan
Title: "ADI Person-Authored Preference Care Plan"
...
* supportingInfo 0..* MS
* supportingInfo only Reference(ADIPersonAuthoredCareExperiencePreference)
