...
* section[administrative_information].entry contains
    ...
    adi_serious_advanced_condition 0..1 MS and
...
* section[administrative_information].entry[adi_serious_advanced_condition] only Reference(ADISeriousAdvancedCondition)
* section[administrative_information].entry[adi_serious_advanced_condition] ^short = "ADI Serious Advanced Condition"
