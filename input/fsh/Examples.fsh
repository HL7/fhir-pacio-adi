...
//* provision.code[+] = PADIHCADecisionsCS#intubation "Intubation"
//* provision.code[+] = PADIHCADecisionsCS#tube-feeding "Tube feeding"
//* provision.code[+] = PADIHCADecisionsCS#life-support "Life support"
