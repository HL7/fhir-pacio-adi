...
* #cancelled "cancelled" "The composition is unavailable because the measurement was not started or not completed (also sometimes called \"aborted\")."
* #entered-in-error "Entered in error" "The composition or document was originally created/issued in error, and this is an amendment that marks that the entire series should not be considered as valid."
* #deprecated "Deprecated" "This composition has been withdrawn or superseded and should no longer be used."
* ^caseSensitive = true
* ^experimental = false
* ^copyright = "This CodeSystem is not copyrighted."
