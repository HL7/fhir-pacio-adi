...
Expression: "section.code.coding.where(code = '81335-2').exists().not() or section.code.coding.where(code = '81335-2').count() > 0 or section.code.coding.where(code = '81335-2').emptyReason.exists()"
Severity:   #error
