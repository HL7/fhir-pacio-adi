...
* ^experimental = false
* include $LOINC#64298-3 "Power of attorney" "A power of attorney or POA is a legal document which authorizes someone to act on behalf of someone else. The person granting the power of attorney is known as the principal, granter, or donor, while the person authorized to act is called an agent, attorney-in-fact, or attorney. There are many different types of POAs, and each can be further customized to suit the requirements of the granter. In short, it all depends on the content of the contract. Power of attorney documents in LOINC represent a medical or durable power of attorney.
(These are statutory defined documents e.g., those defined by states. For the purposes of advance directive information, this code identifies documents representing power of attorney for healthcare decision making). "
* include $LOINC#81334-5 "Patient Personal advance care plan" "This term may be used as either the document or section code for the Personal Advance Care Plan. This term was created for, but is not limited in use to, the HL7 Implementation Guide for CDA Release 2: Personal Advance Care Plan Document (US Realm) Draft Standard for Trial Use Release 1.0.
(It may include patient goals, preferences, and priorities under certain health conditions; patient goals, preferences, and priorities upon death; patient goals, preferences, and priorities for care experience; witness and notary information; and patient healthcare agent.)"
* include $LOINC#86533-7 "Patient Living will" "Clinical information generated by a patient, or a patient agent (proxy), acting in a non-clinical role to provide clinically relevant information. The patient agent may not have a legally defined relationship with the patient (e.g. a close friend).
(These are statutory defined documents e.g., those defined by states. They provide relevant clinical information related the wishes for potential future event requiring medical treatment where the patient is unable to speak for themselves.)"
* include $LOINC#92664-2 "Power of attorney and Living will" "A combined power of attorney and living will form. Power of attorney in LOINC represents a medical or durable power of attorney.
(For the purposes of advance directive information, Power of Attorney documents specifically represent power of attorney for healthcare decision making)"
